...
- Latest follow-up commit checked: `3d216f8` (`v0.6.5`, 2026-06-28)
- Snapshot policy: upstream is not vendored in this repository. Clone or update
  it under `workplace/` when comparing parity.

## Sister Java Reference

- Repository: <https://github.com/igapyon/miku-md2docx-java>
- Local checkout path used during initialization: `workplace/miku-md2docx-java`
- Checked commit: `730fc62cbe1cdade82f5af900f21211e96b8f7c6`
